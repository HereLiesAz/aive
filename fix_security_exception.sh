...
# SecurityException is a JVM-specific exception, use RuntimeException for KMP compatibility.
cat << 'MEDEOF' > shared/src/commonMain/kotlin/com/hereliesaz/geministrator/addons/HaiveAddonMediator.kt
...
cat << 'TESTUPDATEEOF' > shared/src/desktopTest/kotlin/com/hereliesaz/geministrator/addons/AddonSystemTest.kt
package com.hereliesaz.geministrator.addons
